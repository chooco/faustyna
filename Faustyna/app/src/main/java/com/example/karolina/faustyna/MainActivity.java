...
public class MainActivity extends AppCompatActivity
    ...
    public void onSectionAttached(int number) {
        switch (number) {
            case 1:
                mTitle = getString(R.string.titleAktualnosci);
                break;
            case 2:
                mTitle = getString(R.string.titleDzienniczek);
                break;
            case 3:
                mTitle = getString(R.string.titleNabozenstwo);
                break;
            case 4:
                mTitle = getString(R.string.titleFaustyna);
                break;
            case 5:
                mTitle = getString(R.string.titleSanktuarium);
                break;
            case 6:
                mTitle = getString(R.string.titleGaleria);
                break;
            case 7:
                mTitle = getString(R.string.titleTransmisja);
                break;
            case 8:
                mTitle = getString(R.string.titleKoronka);
                break;
            case 9:
                mTitle = getString(R.string.titleSklep);
                break;
            case 10:
                mTitle = getString(R.string.titleKwartalnik);
                break;
            case 11:
            ...
            case 13:
                ...
                break;
            case 14:
                mTitle = getString(R.string.titleWsparcie);
                break;
            case 15:
